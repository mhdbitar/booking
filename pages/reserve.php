...
<body>
  ...
  <form action="search1.php?id=<?= $_GET['id'] ?>" method="post">
  ...
  <form action="search1.php?id=<?= $_GET['id'] ?>" method="post" name="weekForm" onsubmit="return check()">
  ...
  <form action="search1.php?id=<?= $_GET['id'] ?>" method="post" name="monthForm" onsubmit="return checkMonth()">
